<template>
  <div id="audio-player-root" class="player-main" >
    ...
    <div>
      ...
      <div class="w-3/4 bg-gray-200 border border-gray-300 px-2 pt-2 mt-4 shadow-md" style="margin: auto;">
        <div id="player-row" class="inline-flex flex-wrap w-full max-w-5xl">
          ...
          <div id="progress-bar" class="flex-grow bg-white border border-blue-200">
            <div class="overlay-container relative w-full h-full">
              ...
              <div v-show="audioLoaded" class="flex w-full justify-between absolute top-0 bottom-0 right-0 left-0 px-2 pointer-events-none">
